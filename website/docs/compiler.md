...
Without a compiler, you'd manage tool registration manually, rebuild prompt strings on every change, and track component identity yourself. The compiler automates all of this.
