...
features:
  ...
  - icon: 📂
    ...
    details: Screenshots, audio, PDFs in history collapse to text summaries. The model expands them to "re-see" or "re-hear" content on demand — then they auto-collapse to keep the window lean.
  - icon: 🔌
    title: Connectors
