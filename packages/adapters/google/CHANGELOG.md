...
- cbfe307: Fix Bedrock tool calls arriving with empty arguments, and prefer enriched JSON Schema for tool specs in both adapters.
...
- 1c45679: Fix: concatenate multiple `role: "system"` messages into Google's `systemInstruction` instead of last-write-wins.
