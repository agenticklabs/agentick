/**
 * `@agentick/client-react` — React bindings for the agentick wire client.
 *
 ...
 *
 * ```tsx
 * import { useHandle, useView } from "@agentick/client-react";
 *
 ...
 * surface (`@agentick/compiler-react` / `BridgeProvider`), which compiles
