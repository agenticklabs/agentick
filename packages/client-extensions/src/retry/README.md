# `@agentick/client-extensions/retry`

Retry extension for `@agentick/client-core`. Exponential backoff with
...
- **Circuit breaker** — stop retrying entire methods when failure rate
  ...
  ship as a sibling subpath (`@agentick/client-extensions/circuit-breaker`) if demand surfaces.
