# `@agentick/client-extensions/telemetry`

Telemetry extension for `@agentick/client-core` — span per logical RPC,
...
import { telemetry, type TelemetryAdapter } from "@agentick/client-extensions/telemetry";

const tracer = trace.getTracer("@agentick/client-core");
...
```ts
import { telemetry, noopAdapter } from "@agentick/client-extensions/telemetry";
