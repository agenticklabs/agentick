 ...
 * executor + target. `compiler-react`'s `useModelRegistration`
 ...
 * @see packages/spec/src/protocol/hook-bridges.ts (ModelBridge)
 */

import type { ModelBridge, RegisteredModel, Unsubscribe } from "@agentick/spec";
