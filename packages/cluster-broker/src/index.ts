/**
 * `@agentick/cluster-broker` — broker-pattern base for cluster
 * transport adapters that run their own broker process.
 *
 * Concrete wire packages subclass:
 *
 *   - `@agentick/cluster-net` (Phase 4b/4d) — TCP + Unix socket
 *   - `@agentick/cluster-ws`  (Phase 4e)    — WebSocket
 *
 * External-broker adapters (`@agentick/cluster-redis`, etc.)
