/**
 * `@agentick/cluster` — cluster protocol package for Agentick v2.
 *
 * Provides:
 ...
 *     packages (`@agentick/cluster-ipc`,
 *     `@agentick/cluster-redis`, `@agentick/cluster-nats`).
 *   - Wire serialization other than JSON — additional codecs ship
 *     as `@agentick/cluster-codec-msgpack`, etc.
 *
