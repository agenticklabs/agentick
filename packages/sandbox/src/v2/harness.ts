...
import { BaseHarness, runHarnessProtocol } from "@agentick/runtime";
import type {
  EventBus,
  MessageEnvelope,
  MessageHandlerError,
...
export class SandboxHarness extends BaseHarness<"sandbox"> {
  ...
  static async fromProvider(
    ...
    init: {
      ...
      readonly options: import("@agentick/spec").SandboxCreateOptions;
      readonly acl?: SandboxACL;
    },
...
function applyEditsLocal(
  current: string,
  edits: readonly import("@agentick/spec").SandboxEdit[],
