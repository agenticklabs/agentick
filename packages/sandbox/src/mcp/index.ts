/**
 * `@agentick/sandbox/mcp` — opt-in sandbox ↔ MCP/resources adapters
 * (ADR 65). Deps `@agentick/mcp` + `@agentick/resources`; the
 ...
 * needs no sandbox and lives in `@agentick/mcp`'s server harness.
 *
