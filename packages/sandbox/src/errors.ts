 ...
 * live in `@agentick/spec/errors/remaining.ts`; this module
 * re-exports them at the existing import path so adopter code doesn't
 * change. New code SHOULD import directly from `@agentick/spec`.
 *
...
import { SandboxExecError, SandboxIoError, SandboxPermissionDeniedError } from "@agentick/spec";
