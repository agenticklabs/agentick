/**
 * ReconcilerContainer — the root of one host tree.
 *
 ...
 * top-level children.
 *
 * Containers are private to the reconciler harness — they never cross
 * the spec firewall.
 */
 ...
 */
export function createContainer(input: CreateContainerInput): ReconcilerContainer {
  return {
