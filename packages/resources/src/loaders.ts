 ...
 * {@link import("@agentick/spec").ResourceDeclarationRecord} (→ the store) AND the
 ...
 * @see packages/prompts/src/loaders.ts
 */

import type { ResourceDeclarationRecord, ResourceResolver } from "@agentick/spec";
import { resourceDeclarationKey } from "@agentick/spec";
import {
