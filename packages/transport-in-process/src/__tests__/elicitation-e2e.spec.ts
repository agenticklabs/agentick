 ...
 *
 * Side-effect import of `@agentick/elicitation` registers the
...
import { respondToElicitation, type ElicitationsHandle } from "@agentick/elicitation/client";
import type { ClientElicitationHandle } from "@agentick/spec";
