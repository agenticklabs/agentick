/**
 * V2 Host Config for react-reconciler
 *
...
import type { TentickleNode, TentickleContainer, HostContext, Props, UpdatePayload } from "./types";
...
> = {
  ...
  createTextInstance(
    ...
    throw new Error("Raw text nodes are not supported. Wrap text in <Text> component.");
  },
