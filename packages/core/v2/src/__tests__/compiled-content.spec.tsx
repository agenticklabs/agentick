...
import type { CompiledStructure, CompiledSection } from "../compiler/types";
...
function renderSectionContent(section: CompiledSection): string {
  ...
  return renderer.renderBlocks(section.content);
}
...
describe("Compiled Content", () => {
  ...
  describe("content blocks", () => {
    ...
    it("should collect Code content", async () => {
      ...
      expect(section!.content[0].code).toBe("const x = 42;");
      expect(section!.content[0].language).toBe("typescript");
    });
    ...
    it("should collect Image content", async () => {
      ...
      expect(section!.content[0].source).toBe("https://example.com/img.png");
      expect(section!.content[0].alt).toBe("Example");
    });
    ...
    it("should collect Json content", async () => {
      ...
      expect(section!.content[0].json).toEqual(data);
    });
  ...
  describe("content rendering", () => {
    ...
    it("should render code with markdown fences", async () => {
    ...
    it("should render image as markdown", async () => {
      const App = () =>
      ...
      expect(rendered).toBe("![A picture](https://example.com/pic.jpg)");
    });

    it("should render json as code block", async () => {
  ...
  describe("timeline entries", () => {
    ...
    it("should collect Entry with system role", async () => {
      ...
      expect(compiled.timelineEntries[0].role).toBe("system");
    });
