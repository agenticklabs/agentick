...
describe("FiberCompiler", () => {
  ...
  describe("useData hook", () => {
    ...
    it("should handle fetcher errors", async () => {
      ...
      const ErrorComponent = () => {
        const data = useData("error-test", fetchFn);
    ...
    it("useInvalidateData should support regex patterns", async () => {
      ...
      const RegexInvalidateComponent = () => {
        const user1 = useData("user:1", fetchUser1);
        const user2 = useData("user:2", fetchUser2);
        const posts = useData("posts", fetchPosts);
        const invalidate = useInvalidateData();
  ...
  describe("signal hooks", () => {
    ...
    it("signal should notify subscribers on change", () => {
  ...
  describe("hibernation", () => {
    ...
    it("should preserve tick info in cache entries", async () => {
      ...
      const CacheTickComponent = () => {
        const data = useData("tick-cache", fetchFn);
    ...
    it("should preserve deps in cache entries", async () => {
      ...
      const DepsTickComponent = () => {
        const data = useData("deps-cache", fetchFn, { deps: ["a", "b"] });
  ...
  describe("nested components", () => {
    ...
    it("should support deeply nested data fetching", async () => {
      ...
      const Level3 = () => {
        const data = useData("level3", fetchC);
        return React.createElement("Section", { id: "level3" });
      };

      const Level2 = () => {
        const data = useData("level2", fetchB);
        return React.createElement(Level3);
      };

      const Level1 = () => {
        const data = useData("level1", fetchA);
  ...
  describe("unmount and cleanup", () => {
    ...
    it("unmount should clear data cache", async () => {
      ...
      const DataComponent = () => {
        const data = useData("unmount-cache", fetchFn);
