 ...
 * surface that carries the facet — {@link import("@agentick/spec").ToolHandlerCtx}
 ...
 * import { runObservabilityCtxConformance } from "@agentick/spec-conformance";
...
import type { Observability } from "@agentick/spec";
