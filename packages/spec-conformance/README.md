...
| `runExecutorConformance(factory)`                | `LanguageModelExecutor`         | Project/run phase isolation, abort, and cross-adapter parity: base64 image sources, sampling params, `providerOptions` threading, the stream surface                                           |
