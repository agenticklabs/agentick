 ...
 * `@agentick/runtime` — out of scope for this spec module). The
 ...
 * subclasses) re-export from `@agentick/spec/errors`.
 *
...
// import directly from `@agentick/spec/errors`.
export {
  AddressNotFound,
  AskTimeout,
  HandlerError,
