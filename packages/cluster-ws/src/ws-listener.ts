 ...
 * `Listener` interface from `@agentick/cluster-broker`.
 *
 * Two modes:
 *
...
import type { Connection, Listener } from "@agentick/cluster-broker";
...
// `defineWireCluster` into `@agentick/cluster-broker/wire-helpers
