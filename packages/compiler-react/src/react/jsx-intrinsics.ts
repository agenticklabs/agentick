/**
 * JSX.IntrinsicElements augmentation for `@agentick/compiler-react`.
 *
 ...
 * `@agentick/compiler-react` and friends. Those components are
 ...
 * in `packages/compiler/src/collect/contributors/`.
 *
 * # HTML-overlap policy
 *
 ...
 * # Type discipline
 *
 * All prop shapes reference types from `@agentick/spec` where
 ...
 * @see packages/compiler/src/collect/contributors/
 */
...
declare module "react" {
  namespace JSX {
    interface IntrinsicElements {
       ...
       * uppercase `<Message>` wrapper from `@agentick/compiler-react`.
       */
      message: {
        readonly id?: string;
      ...
      // wrappers from `@agentick/compiler-react`. Only `document`
