/**
 * `@agentick/cluster-net` — TCP + Unix-socket cluster transport.
 *
 * Concrete wire impl on top of `@agentick/cluster-broker`. Phase
...
// `@agentick/cluster` as `makeClusterNode`; this package's
