 ...
 * @see packages/tasks/src/harness.ts — the fire side (settle → wake)
 * @see packages/session/src/harness.ts — the receive side (handleMessage)
 */

import type { SendInput, TaskWakeOutcome } from "@agentick/spec";
