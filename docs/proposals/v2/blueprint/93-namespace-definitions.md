...
| live | `app.live` | `defineLive({})` | none (bags-first) | hooks/guards on the promoted ops (stop/close; start pending Family 3); provider/genesis slots when the media story demands them |
