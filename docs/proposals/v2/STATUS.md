...
**Branch:** `feat/v2`
**Last updated:** 2026-07-01 (later) — **A2 landed: `TimelineStore` durability port (ADR 49) — store-backed persisted tier, write-behind + `flush()` barrier, typed failures. Plus a typed-error sweep (B1 slot collision + compaction failure).**
