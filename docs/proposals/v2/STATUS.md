...
**Branch:** `feat/v2`
**Last updated:** 2026-07-07 — **Ingress authn ADR 61 slice 1 LANDED (`59b66185`): one `interceptIngress` seam across all transports; prod HTTP edge now authenticates. Sandbox: ADR 60 + `sandbox-lambda-next` core contract landed (`9ab97cd6`).**
