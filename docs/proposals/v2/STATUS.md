...
**Branch:** `feat/v2`
**Last updated:** 2026-06-02 — **G9 + G11 closed; layered providerOptions architecture across all four executors; ADR 29 (bus overhaul) proposed; pre-compiled query matchers shipped (Phase A of ADR 29).**
