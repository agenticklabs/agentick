...
**Branch:** `feat/v2`
**Last updated:** 2026-07-03 (later still) — **#150 ADR 52 IMPLEMENTED end-to-end: the ONE LanguageModelExecutor, four providers converted to adapters, @agentick/model-next carved out, packages renamed model-<provider>-next.**
