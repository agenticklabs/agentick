...
**Branch:** `feat/v2`
**Last updated:** 2026-07-02 (night) — **ADR 51 slice 4 LANDED: timeline migrates to declared commands; `compact` becomes an addressable verb. ADR 52 gains the modalities section.**
