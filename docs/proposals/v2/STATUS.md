...
**Branch:** `feat/v2`
**Last updated:** 2026-07-07 — **Sandbox prod track: ADR 60 re-grounded on the REAL Lambda MicroVMs offering; `sandbox-lambda-next` core contract LANDED (`9ab97cd6`) — Topology A, loopback-conformance green.**
