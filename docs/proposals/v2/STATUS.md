...
**Branch:** `feat/v2`
**Last updated:** 2026-06-25 — **Cluster Phase 3 — `ClusterEventBus` + `ClusterInbox` wrapper impls landed.** `defineCluster` no longer pass-through; the returned `Cluster` value carries real wrapped substrate.
