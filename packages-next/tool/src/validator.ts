 ...
 * `@agentick/tool-executor-next/validator`. The two packages are peers
 * (both consume `@agentick/spec-next`); duplicating the 15 lines avoids a
...
import type { StandardSchemaV1, Validator, ValidatorResult } from "@agentick/spec-next";
