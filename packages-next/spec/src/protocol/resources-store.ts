 ...
 * in-memory default ({@link import("@agentick/resources-next").InMemoryResourceStore})
 * and the `runResourceStoreConformance` suite live in `@agentick/resources-next`
 ...
 * `@agentick/resources-next`), exactly like `PromptStore` / `SkillStore`.
 *
