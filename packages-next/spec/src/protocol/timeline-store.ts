 ...
 * `@agentick/timeline-fs-next` (JSONL, local pole), `-sqlite-next` (recommended
 * first durable), `-postgres-next` (cloud pole). The bundled default is
 * `MemoryTimelineStore` (`@agentick/timeline-next`), a thin binding of the
 * generic `MemoryLog<T>` (`@agentick/store-next`).
 *
