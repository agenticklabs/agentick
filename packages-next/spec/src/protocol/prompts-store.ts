 ...
 * The bundled in-memory default ({@link import("@agentick/prompts-next").InMemoryPromptStore})
 * and the `runPromptStoreConformance` suite live in `@agentick/prompts-next`
 ...
 * `@agentick/prompts-next`), exactly like `SkillStore` / the timeline stores.
 *
