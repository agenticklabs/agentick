...
/**
 * @agentick/compiler-react-next — React compiler implementation.
 *
 * React-specific layer over `@agentick/compiler-next` (which owns the
...
// React-specific host config layer (binds @agentick/compiler-next's
...
// and lifecycle dispatch from `@agentick/compiler-next`.
...
// compiler into createApp. Also defaulted by @agentick/app-next/react.
