 ...
 *
 * @verifiedBy packages-next/tool-executor/src/client/__tests__/tools-handle.spec.ts
 * @verifiedBy packages-next/tool-executor/src/client/__tests__/session-tools.spec.ts
 */
