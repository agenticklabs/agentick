 ...
 * {@link import("@agentick/spec-next").CollectionStore} (the collection
 ...
 * @verifiedBy packages-next/store/src/__tests__/log-view.spec.ts
 */

import type { LogStore, StoreCtx } from "@agentick/spec-next";
import { createNotifier, type Notifier, type Unsubscribe } from "@agentick/pubsub-next";
