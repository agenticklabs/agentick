...
built on [`@agentick/cluster-broker-next`](../cluster-broker) + the
...
import { defineWsCluster, wsBroker } from "@agentick/cluster-ws-next";
...
```typescript
import { wsBroker, defineWsCluster } from "@agentick/cluster-ws-next";
