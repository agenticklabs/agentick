 ...
 *
 * @verifiedBy packages-next/client-react/src/__tests__/use-handle.spec.tsx
 * @verifiedBy packages-next/client-react/src/__tests__/integration-with-handle.spec.tsx
 */
