 ...
 *
 * @verifiedBy packages-next/gates/src/client/__tests__/gates-handle.spec.ts
 * @verifiedBy packages-next/gates/src/client/__tests__/session-gates.spec.ts
 */

import type { ClientHandle, Enumerable } from "@agentick/client-core-next";
import type { ClientTransport, Unsubscribe } from "@agentick/spec-next";
