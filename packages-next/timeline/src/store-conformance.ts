 ...
 * the reference `@agentick/timeline-fs-next` / `-sqlite-next` / `-postgres-next`,
 ...
 * runStoreConformance} skeleton (`@agentick/store-next`) via its `emptyRead` /
 ...
 * hook. Mirrors `runTaskStoreConformance` (`@agentick/tasks-next`).
 *
