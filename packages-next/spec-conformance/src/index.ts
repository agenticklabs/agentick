/**
 * @agentick/spec-conformance-next — internal conformance fixtures.
 *
 * The executable form of the pluggability charter. Any implementation
 * of an `@agentick/spec-next` protocol interface passes the matching suite
...
// `@agentick/knobs-next`, etc.), not here.
