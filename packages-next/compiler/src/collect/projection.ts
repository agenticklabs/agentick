 ...
 * so it lives here rather than in a compiler binding.
 *
 ...
 * harness and is contributed by the compiler binding
 * (`@agentick/compiler-react-next`), which reads it structurally from
