 ...
 *
 * Lives in `@agentick/runtime-next` (not a compiler-specific package)
 ...
 * without depending on `@agentick/compiler-react-next`.
 *
 ...
 * `@agentick/compiler-react-next`. `defineCompiler` exists for the
