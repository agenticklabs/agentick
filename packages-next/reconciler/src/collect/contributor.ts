...
import type { FormatPurpose } from "@agentick/spec-next";
...
export interface CollectContext {
  ...
  collectContentBlocks(
    parent: HostInstance,
    outbound?: IRFragment[],
  ): readonly import("@agentick/spec-next").ContentBlock[];
   ...
   */
  formatter(purpose?: FormatPurpose): import("@agentick/spec-next").FormatterRef;
}
