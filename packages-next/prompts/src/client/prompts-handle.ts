 ...
 *
 * @verifiedBy packages-next/prompts/src/client/__tests__/prompts-handle.spec.ts
 * @verifiedBy packages-next/prompts/src/client/__tests__/session-prompts.spec.ts
 */
