...
- `@agentick/client-core-next` (this package) — the canonical impl
...
```
                    ...
                    │   ──── implemented by ────     │
                    │ @agentick/client-core-next          │   ← this package
                    └───────────────┬────────────────┘
                                    │ uses
                                    ▼
                    ┌────────────────────────────────┐
...
import { onLog, onProgress } from "@agentick/client-core-next";
...
> "@agentick/client-next"` lights up all built-in slots automatically (the client
