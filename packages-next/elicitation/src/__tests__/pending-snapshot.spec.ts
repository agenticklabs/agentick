 ...
 * prepend) is proven in `@agentick/session-next` + `@agentick/gateway-next`.
 */

import { afterEach, describe, expect, it } from "vitest";
import { waitFor } from "@agentick/utils-next/testing";
import { isChannelSnapshotProvider, jsonSchema, type StandardSchemaV1 } from "@agentick/spec-next";
