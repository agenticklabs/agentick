 ...
 * `SessionInstaller` (`@agentick/app-next`), and `GatewayInstaller`
 * (`@agentick/gateway-next`) `subscribeBus` implementations — which had
...
import type { EventBus, EventQuery, ProtocolEvent, Unsubscribe } from "@agentick/spec-next";
