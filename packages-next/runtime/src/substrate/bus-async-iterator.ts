 ...
 *
 * Extracted from duplicated copies in `@agentick/app-next/harness.ts`
 * and `@agentick/gateway-next/harness.ts`. The bridge is small but
...
import type { EventBus, EventQuery, ProtocolEvent, SubscribeOptions } from "@agentick/spec-next";
