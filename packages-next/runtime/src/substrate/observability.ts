 ...
 * @verifiedBy packages-next/runtime/src/__tests__/interceptor-ctx-facets.spec.ts
 */
 ...
 * {@link deriveObservability}. Widens spec's {@link import("@agentick/spec-next").LogEmit}
 * with the `trace` argument the facet computes at each call: the surface
 * forwards it onto the emitted {@link import("@agentick/spec-next").LogEventPayload}
