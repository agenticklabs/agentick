...
import { forkBusSubscription } from "@agentick/runtime-next";
 ...
 *
 * @verifiedBy packages-next/mcp/src/server/__tests__/projection-completions-logging.spec.ts
 */
 ...
 *
 * @verifiedBy packages-next/mcp/src/server/__tests__/progress.spec.ts
 */
