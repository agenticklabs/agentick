...
import { createTool, createToolCatalog, type MutableToolCatalog } from "@agentick/tool-next";
 ...
 * concrete classes — that would force `@agentick/resources-next` (which
 * no `@agentick/mcp-next` SOURCE constructs — the server PROJECTS the
