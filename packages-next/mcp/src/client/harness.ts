 ...
 *
 * Inbound server-to-client requests (elicitation/create, sampling,
 * roots) are NOT handled here — #4 wires them through
 * `client.setRequestHandler(...)` and routes to the substrate's
 * elicitation harness etc.
 *
