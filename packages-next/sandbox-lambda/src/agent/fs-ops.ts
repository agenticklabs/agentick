 ...
 * transform (re-exported from `@agentick/sandbox-next`) IN-VM and writes back
...
import type { SandboxEdit, SandboxEditResult } from "@agentick/sandbox-next";
import { SandboxEscapeError, SandboxIoError } from "@agentick/sandbox-next";
